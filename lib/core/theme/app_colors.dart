...
class AppColors {
  ...
  // Purples (brand)
  static const Color purpleLight = Color(0xFFB284BB);
  static const Color purpleMid = Color(0xFF97719F);
  static const Color purpleDark = Color(0xFF674F6C);
  static const Color purpleDarker = Color(0xFF39263B);
  ...
  static const Color textSecondary = Color(0xFFCEC4D6);
  ...
  static const Color barChartActiveColor = Color(0xFFa846fe);
